...
#include "ackermann_planning/task.h"

namespace ackermann_planning::pnc {
constexpr static const char* NODE_NAME = "state_machine";
...
constexpr static const char* TASK_SRV = "task";
...
private:
  ...
  auto task_service(ackermann_planning::task::Request& req, ackermann_planning::task::Response& resp) -> bool;
